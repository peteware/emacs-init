...
;; [[file:~/usr/emacs-init/main-init.org::*Preamble][Preamble:1]]
(provide 'main-init)
...
;; [[file:~/usr/emacs-init/main-init.org::*Setup%20proxies%20for%20package%20installation][Setup proxies for package installation:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Setup%20use-package][Setup use-package:1]]
(eval-when-compile
  (require 'use-package))
...
;; [[file:~/usr/emacs-init/main-init.org::*package][package:1]]
(use-package package
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*bind-key][bind-key:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*bookmark][bookmark:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*delsel][delsel:1]]
(use-package delsel
  :config
...
;; [[file:~/usr/emacs-init/main-init.org::*desktop][desktop:1]]
(use-package desktop
  ;:defer 10
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*executable][executable:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*face-remap][face-remap:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*jit-lock][jit-lock:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*jka-cmpr-hook][jka-cmpr-hook:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*mwheel][mwheel:1]]
(use-package mwheel
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*outline][outline:1]]
(use-package outline
  :config
...
;; [[file:~/usr/emacs-init/main-init.org::*paren][paren:1]]
(use-package paren
  :defer 60
  :config
  (show-paren-mode 1))
...
;; [[file:~/usr/emacs-init/main-init.org::*recentf][recentf:1]]
(use-package recentf
  ;;
...
;; [[file:~/usr/emacs-init/main-init.org::*savehist][savehist:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*saveplace][saveplace:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*scroll-bar][scroll-bar:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*server][server:1]]
(use-package server
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*toolkit-tramp][toolkit-tramp:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*uniquify][uniquify:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*atomic-chrome][atomic-chrome:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*bb-style][bb-style:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*delight][delight:1]]
(use-package delight
  :ensure t)
;; delight:1 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*fancy-narrow][fancy-narrow:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*ivy][ivy:1]]
(use-package ivy
  :ensure t
  :delight ivy-mode
...
;; [[file:~/usr/emacs-init/main-init.org::*counsel][counsel:1]]
(use-package counsel
  :after ivy
  :ensure t
...
;; [[file:~/usr/emacs-init/main-init.org::*swiper][swiper:1]]
(use-package swiper
  :after ivy
  :ensure t
  :bind (("C-s" . 'swiper)))
...
;; [[file:~/usr/emacs-init/main-init.org::*scratch-ext][scratch-ext:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*compile][compile:1]]
(use-package compile
  :bind ("C-c c" . compile)
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*ansi-color][ansi-color:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*ediff][ediff:1]]
(use-package ediff
...
;; [[file:~/usr/emacs-init/main-init.org::*follow][follow:1]]
(use-package follow
...
;; [[file:~/usr/emacs-init/main-init.org::*grep][grep:1]]
(use-package grep
  ;:bind (("C-c g" . grep))
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*hideshow][hideshow:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*linum][linum:1]]
(use-package linum
  :commands linum-mode
...
;; [[file:~/usr/emacs-init/main-init.org::*org][org:1]]
(use-package org
  :mode ("\\.org\\'" . org-mode)
...
;; [[file:~/usr/emacs-init/main-init.org::*org][org:2]]
(use-package org-prefs
  :after org)
;; org:2 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*whitespace][whitespace:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*pw-misc][pw-misc:1]]
(use-package pw-misc
  :after compile
  :config
...
;; [[file:~/usr/emacs-init/main-init.org::*anyins][anyins:1]]
(use-package anyins
  ;;
...
;; [[file:~/usr/emacs-init/main-init.org::*avy][avy:1]]
(use-package avy
  :ensure t
...
;; [[file:~/usr/emacs-init/main-init.org::*beacon][beacon:1]]
(use-package beacon
  :config
  (progn
    (beacon-mode 1)
...
;; [[file:~/usr/emacs-init/main-init.org::*comint-prefs][comint-prefs:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*csc-mode][csc-mode:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*lrl-mode][lrl-mode:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*magit][magit:1]]
(use-package magit
  :ensure t
...
;; [[file:~/usr/emacs-init/main-init.org::*multiple-cursors][multiple-cursors:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*ag][ag:1]]
(use-package ag
  :ensure t
  :bind (("C-c f" . ag))
...
;; [[file:~/usr/emacs-init/main-init.org::*pw-trunc-lines][pw-trunc-lines:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*shell-switch][shell-switch:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*treemacs][treemacs:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*wgrep][wgrep:1]]
(use-package wgrep
  :ensure t)
;; wgrep:1 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*zoom-frm][zoom-frm:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*powerline][powerline:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*overcast-theme][overcast-theme:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Various%20preferences][Various preferences:1]]
;;
...
;; [[file:~/usr/emacs-init/main-init.org::*Clean%20startup][Clean startup:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Configure%20the%20mode%20line][Configure the mode line:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Legacy%20(or%20I've%20been%20using%20emacs%20for%20too%20long)][Legacy (or I've been using emacs for too long):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Tune%20scrolling%20behaviour][Tune scrolling behaviour:1]]
(setq scroll-step 0)
...
;; [[file:~/usr/emacs-init/main-init.org::*Tune%20scrolling%20behaviour][Tune scrolling behaviour:2]]
(setq hscroll-margin 1)
(setq hscroll-step 5)
;; Tune scrolling behaviour:2 ends here

;; Incremental search highlighting
;;     Incremental search settings

;; [[file:~/usr/emacs-init/main-init.org::*Incremental%20search%20highlighting][Incremental search highlighting:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Misc%20settings][Misc settings:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Misc%20settings][Misc settings:2]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Misc%20settings][Misc settings:3]]
...
;; [[file:~/usr/emacs-init/main-init.org::*Misc%20settings][Misc settings:4]]
(setq vc-handled-backends nil)
;; Misc settings:4 ends here



;; I don't like actual tabs being inserted

;; [[file:~/usr/emacs-init/main-init.org::*Misc%20settings][Misc settings:5]]
(setq-default indent-tabs-mode nil)
;; Misc settings:5 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:2]]
(setq x-select-enable-primary t)
;; More X11 configuration:2 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:3]]
;(setq x-select-enable-clipboard nil)
;(setq x-select-enable-primary t)
;; More X11 configuration:3 ends here



;; Do not beep if I kill text in a read-only buffer

;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:4]]
(setq kill-read-only-ok t)
;; More X11 configuration:4 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:5]]
(setq backup-directory-alist '(("." . "~/.backups")))
;; More X11 configuration:5 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:6]]
(setq transient-mark-mode t)
;; More X11 configuration:6 ends here



;; Ignore some other file extensions

;; [[file:~/usr/emacs-init/main-init.org::*More%20X11%20configuration][More X11 configuration:7]]
(setq completion-ignored-extensions (append completion-ignored-extensions '(".d" ".dd" ".tsk")))
;; More X11 configuration:7 ends here
...
;; [[file:~/usr/emacs-init/main-init.org::*autorevert%20(disabled)][autorevert (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*cua-base%20(disabled)][cua-base (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*hl-line%20(disabled)][hl-line (disabled):1]]
(use-package hl-line
  :disabled t
  :config
  (progn
...
;; [[file:~/usr/emacs-init/main-init.org::*ido%20(disabled)][ido (disabled):1]]
(use-package ido
  :disabled t
  :defer 5
  :config
...
;; [[file:~/usr/emacs-init/main-init.org::*ido-vertical%20(disabled)][ido-vertical (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*iswitchb%20(disabled)][iswitchb (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*tool-bar%20(disabled)][tool-bar (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*menu-bar%20(disabled)][menu-bar (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*diminish%20(disabled)][diminish (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*git-getter-fringe+%20(disabled)][git-getter-fringe+ (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*magithub%20(disabled)][magithub (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*nlinum%20(disabled)][nlinum (disabled):1]]
(use-package nlinum
  :disabled t
...
;; [[file:~/usr/emacs-init/main-init.org::*fill-column-indicator%20(disabled)][fill-column-indicator (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*num3-mode%20(disabled)][num3-mode (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*color-identifiers-mode%20(disabled)][color-identifiers-mode (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*rainbow-identifiers%20(disabled)][rainbow-identifiers (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*smart-mode-line%20(disabled)][smart-mode-line (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*sublime-themes%20(disabled)][sublime-themes (disabled):1]]
...
;; [[file:~/usr/emacs-init/main-init.org::*dracula-theme%20(disabled)][dracula-theme (disabled):1]]
