...
;;     on startup.  The =saveplace= makes files open be
;;     restored to the last place so load this afte.
...
;;     See =zoom-frm= for changing entire frame
...
;;     I load a bunch of other settings for myself in =org-prefs=
...
;; org-prefs
;;     I have a number of customizations I like to use
;;     for org-mode.
...
;; =ultra-scroll= is a package that makes scrolling much smoother.
