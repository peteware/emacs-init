...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (delight counsel ivy magit-gh-pulls dracula-theme rtags magithub eopengrok mode-icons origami org-beautify-theme git-gutter-fringe+ git-gutter-fringe git-timemachine git-wip-timemachine zoom-frm zerodark-theme zenburn-theme use-package sublime-themes steady-theme smart-mode-line scratch-ext rainbow-identifiers powerline num3-mode nlinum magit log4j-mode ido-vertical-mode fill-column-indicator fastnav fancy-narrow ctags color-theme-modern color-identifiers-mode beacon babcore avy anyins alect-themes ag)))
